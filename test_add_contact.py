...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.open_contactPage(wd)
        self.create_Contact(wd, Contact(firstname="123",
                                        middlename="123",
                                        lastname="123",
                                        nickname="123",
                                        title="123",
        ...
        self.return_to_contactsPage(wd)
        self.loguot(wd)

    def return_to_contactsPage(self, wd):
